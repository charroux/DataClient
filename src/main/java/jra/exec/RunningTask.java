...
public interface RunningTask {
	 ...
	 */
	public List<OutputData> getResult() throws InterruptedException, JRAException;
	 ...
	 * @throws ExecutionException
	 */
	public List<OutputData> getIntermediateResult() throws InterruptedException, JRAException;
	 ...
	 */
	public List<OutputData> getResult(long timeout, TimeUnit unit) throws InterruptedException, JRAException, TimeoutException;
	
	public List<OutputData> getResult(long timeout, TimeUnit unit, UPDATE_STATE_FREQUENCY frequency) throws InterruptedException, JRAException, TimeoutException;
